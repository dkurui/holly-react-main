  ...
  return (
    <div className="container" style={{ overflow: 'hidden' }}>
      ...
      <div className="main-content">
        ...
        <ul
          class="grid w-full gap-4 md:grid-cols-3"
          style={{ display: 'flex', justifyContent: 'left', flexWrap: 'wrap' }}
        >
          <li>
            <input type="checkbox" id="react-option" value="" class="peer hidden" required="" />
            <label
              for="react-option"
              class="peer-checked:border-blue-600 inline-flex w-full cursor-pointer items-center justify-between rounded-lg border-2 border-gray-200 bg-white p-5 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:text-gray-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-gray-300"
            >
              <div class="block">
                <svg
                  class="text-sky-500 mb-2 h-7 w-7"
                  fill="currentColor"
                  aria-hidden="true"
          ...
          <li>
            <input type="checkbox" id="flowbite-option" value="" class="peer hidden" />
            <label
              for="flowbite-option"
              class="peer-checked:border-blue-600 inline-flex w-full cursor-pointer items-center justify-between rounded-lg border-2 border-gray-200 bg-white p-5 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:text-gray-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-gray-300"
            >
              <div class="block">
                <svg
                  class="text-green-400 mb-2 h-7 w-7"
                  fill="currentColor"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
          ...
          <li>
            <input type="checkbox" id="angular-option" value="" class="peer hidden" />
            <label
              for="angular-option"
              class="peer-checked:border-blue-600 inline-flex w-full cursor-pointer items-center justify-between rounded-lg border-2 border-gray-200 bg-white p-5 text-gray-500 hover:bg-gray-50 hover:text-gray-600 peer-checked:text-gray-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-gray-300"
            >
              <div class="block">
                <svg
                  class="text-red-600 mb-2 h-7 w-7"
                  fill="currentColor"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
